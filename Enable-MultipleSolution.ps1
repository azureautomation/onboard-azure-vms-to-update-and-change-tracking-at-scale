...
$ExistingVMExtension = Get-AzureRmResource -ResourceGroupName $AlreadyOnboardedVMResourceGroup -Name $AlreadyOnboardedVM `
                                            ...
                                            | Where-Object {$_.Properties.type -eq "MicrosoftMonitoringAgent" -or $_.Properties.type -eq "OmsAgentForLinux"}
...
{   
   ...
   if (!([string]::IsNullOrEmpty($SubscriptionId)))
   {
       $RunbookNameParams.Add("VMSubscriptionId",$SubscriptionId)
   }
